...

{
  ...
  services.nfs.server = {
    ...
    statdPort = 4000;
    exports = ''
      /mnt/dpool/public 192.168.131.5(rw,no_subtree_check) 192.168.131.15(rw,no_subtree_check,no_root_squash) 192.168.131.16(rw,no_subtree_check,no_root_squash)
